    ...
    if ( ! function_exists('automaticas_post_type') ) {
        ...
        function automaticas_post_type() {
            ...
            $labels = array(
                ...
                'menu_name'             => __( 'Automatica', 'text_domain' ),
                'name_admin_bar'        => __( 'Automatica', 'text_domain' ),
                'archives'              => __( 'Item Archives', 'text_domain' ),
                'attributes'            => __( 'Item Attributes', 'text_domain' ),
                'parent_item_colon'     => __( 'Parent Item:', 'text_domain' ),
                'all_items'             => __( 'All Items', 'text_domain' ),
            ...
            $args = array(
                ...
                'description'           => __( 'general de automaticas', 'text_domain' ),
                'labels'                => $labels,
                'supports'              => array( 'title', 'editor', 'thumbnail' ),
                'taxonomies'            => array( 'category', 'post_tag' ),
                'hierarchical'          => false,
...
// CPT SUSTRATOS
    ...
    if ( ! function_exists('sustrato_post_type') ) {

        // Register Custom Post Type
        function sustrato_post_type() {
        
            $labels = array(
                'name'                  => _x( 'sustratos', 'Post Type General Name', 'text_domain' ),
                'singular_name'         => _x( 'sustrato', 'Post Type Singular Name', 'text_domain' ),
                'menu_name'             => __( 'Sustrato', 'text_domain' ),
                'name_admin_bar'        => __( 'Sustrato', 'text_domain' ),
                'archives'              => __( 'Item Archives', 'text_domain' ),
                'attributes'            => __( 'Item Attributes', 'text_domain' ),
                'parent_item_colon'     => __( 'Parent Item:', 'text_domain' ),
                'all_items'             => __( 'All Items', 'text_domain' ),
            ...
            $args = array(
                'label'                 => __( 'sustrato', 'text_domain' ),
                'description'           => __( 'general de sustrato', 'text_domain' ),
                'labels'                => $labels,
                'supports'              => array( 'title', 'editor', 'thumbnail' ),
                'taxonomies'            => array( 'category', 'post_tag' ),
                'hierarchical'          => false,
            ...
            register_post_type( 'sustrato', $args );
        
        }
        add_action( 'init', 'sustrato_post_type', 0 );
        
        }

// CPT FERTILIZANTE

    if ( ! function_exists('fertilizante_post_type') ) {

        // Register Custom Post Type
        function fertilizante_post_type() {
        
            $labels = array(
                'name'                  => _x( 'fertilizantes', 'Post Type General Name', 'text_domain' ),
                'singular_name'         => _x( 'fertilizante', 'Post Type Singular Name', 'text_domain' ),
                'menu_name'             => __( 'Fertilizantes', 'text_domain' ),
                'name_admin_bar'        => __( 'Fertilizantes', 'text_domain' ),
                'archives'              => __( 'Item Archives', 'text_domain' ),
                'attributes'            => __( 'Item Attributes', 'text_domain' ),
                'parent_item_colon'     => __( 'Parent Item:', 'text_domain' ),
                'all_items'             => __( 'All Items', 'text_domain' ),
            ...
            $args = array(
                'label'                 => __( 'fertilizante', 'text_domain' ),
                'description'           => __( 'general defertilizante', 'text_domain' ),
                'labels'                => $labels,
                'supports'              => array( 'title', 'editor', 'thumbnail' ),
                'taxonomies'            => array( 'category', 'post_tag' ),
                'hierarchical'          => false,
            ...
            register_post_type( 'fertilizante', $args );
        
        }
        add_action( 'init', 'fertilizante_post_type', 0 );
        
        }

// CPT BONG
    
    if ( ! function_exists('bong_post_type') ) {

        // Register Custom Post Type
        function bong_post_type() {
        
            $labels = array(
                'name'                  => _x( 'bongs', 'Post Type General Name', 'text_domain' ),
                'singular_name'         => _x( 'bong', 'Post Type Singular Name', 'text_domain' ),
                'menu_name'             => __( 'Bongs', 'text_domain' ),
                'name_admin_bar'        => __( 'Bongs', 'text_domain' ),
                'archives'              => __( 'Item Archives', 'text_domain' ),
                'attributes'            => __( 'Item Attributes', 'text_domain' ),
                'parent_item_colon'     => __( 'Parent Item:', 'text_domain' ),
                'all_items'             => __( 'All Items', 'text_domain' ),
            ...
            $args = array(
                'label'                 => __( 'bong', 'text_domain' ),
                'description'           => __( 'general de bong', 'text_domain' ),
                'labels'                => $labels,
                'supports'              => array( 'title', 'editor', 'thumbnail' ),
                'taxonomies'            => array( 'category', 'post_tag' ),
                'hierarchical'          => false,
            ...
            register_post_type( 'bong', $args );
        
        }
        add_action( 'init', 'bong_post_type', 0 );
        
        }

// CPT PIPAS

    if ( ! function_exists('pipa_post_type') ) {

        // Register Custom Post Type
        function pipa_post_type() {
        
            $labels = array(
                'name'                  => _x( 'pipas', 'Post Type General Name', 'text_domain' ),
                'singular_name'         => _x( 'pipa', 'Post Type Singular Name', 'text_domain' ),
                'menu_name'             => __( 'Pipas', 'text_domain' ),
                'name_admin_bar'        => __( 'Pipas', 'text_domain' ),
                'archives'              => __( 'Item Archives', 'text_domain' ),
                'attributes'            => __( 'Item Attributes', 'text_domain' ),
                'parent_item_colon'     => __( 'Parent Item:', 'text_domain' ),
                'all_items'             => __( 'All Items', 'text_domain' ),
            ...
            $args = array(
                'label'                 => __( 'pipa', 'text_domain' ),
                'description'           => __( 'general de pipa', 'text_domain' ),
                'labels'                => $labels,
                'supports'              => array( 'title', 'editor', 'thumbnail' ),
                'taxonomies'            => array( 'category', 'post_tag' ),
                'hierarchical'          => false,
            ...
            register_post_type( 'pipa', $args );
        
        }
        add_action( 'init', 'pipa_post_type', 0 );
